...
def main():
    ...
    germination_0, germination_1 = count_values(
        germination_source_file, germination_value
    )
    balanced_count = min(germination_0, germination_1)

    create_balanced_copy(
        germination_source_file,
        germination_target_file,
        germination_value,
        balanced_count,
    )
    ...
    create_balanced_copy(
        spore_source_file, spore_target_file, spore_value, balanced_count
    )
    ...
    create_training_testing_sets(
        germination_target_file,
        germination_training_file,
        germination_testing_file,
        germination_value,
    )
    ...
    create_training_testing_sets(
        spore_target_file, spore_training_file, spore_testing_file, spore_value
    )
